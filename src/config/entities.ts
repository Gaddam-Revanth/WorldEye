...
export const ENTITY_REGISTRY: EntityEntry[] = [
  ...
  // Energy Commodities
  {
    ...
    type: 'commodity',
    name: 'Crude Oil WTI',
    aliases: ['oil', 'crude', 'wti', 'crude oil', 'petroleum', 'barrel'],
    keywords: ['opec', 'drilling', 'refinery', 'pipeline', 'energy', 'gasoline', 'fuel', 'energy security'],
    related: ['BZ=F', 'NG=F', 'XOM', 'CVX', 'XLE', 'RU', 'SA'],
  },
  {
    id: 'BZ=F',
    type: 'commodity',
    name: 'Brent Crude',
    aliases: ['brent', 'brent oil', 'bre'],
    keywords: ['north sea', 'eu oil', 'global benchmark', 'energy', 'petroleum'],
    related: ['CL=F', 'NG=F', 'XOM', 'SA'],
  },
  {
    id: 'NG=F',
    type: 'commodity',
    name: 'Natural Gas HH',
    aliases: ['natural gas', 'natgas', 'gas', 'henry hub'],
    keywords: ['lng', 'pipeline', 'heating', 'energy', 'utility', 'winter demand'],
    related: ['CL=F', 'BZ=F', 'UGA=F', 'XLE', 'RU', 'UA'],
  },
  {
    id: 'UGA=F',
    type: 'commodity',
    name: 'Uranium',
    aliases: ['uranium', 'uran', 'nuclear fuel'],
    keywords: ['nuclear power', 'uec', 'mining', 'climate', 'energy transition', 'kazakh'],
    related: ['NG=F', 'CL=F', 'FCX'],
  },
  // Industrial Metals
  {
    id: 'HG=F',
    type: 'commodity',
    name: 'Copper Futures',
    aliases: ['copper', 'dr copper', 'cu'],
    keywords: ['industrial metal', 'construction', 'wiring', 'ev', 'infrastructure', 'china demand'],
    related: ['AL=F', 'ZN=F', 'NI=F', 'FCX', 'CN', 'TSLA'],
  },
  {
    id: 'AL=F',
    type: 'commodity',
    ...
    keywords: ['industrial metal', 'aerospace', 'automotive', 'light metal', 'smelting'],
    related: ['HG=F', 'ZN=F', 'CN'],
  },
  {
    id: 'ZN=F',
    type: 'commodity',
    name: 'Zinc',
    aliases: ['zinc', 'zn'],
    keywords: ['industrial metal', 'galvanizing', 'construction', 'automotive', 'coating'],
    related: ['HG=F', 'AL=F', 'NI=F'],
  },
  {
    id: 'NI=F',
    type: 'commodity',
    name: 'Nickel',
    aliases: ['nickel', 'ni'],
    keywords: ['stainless steel', 'battery', 'ev', 'mining', 'indonesia'],
    related: ['HG=F', 'ZN=F', 'ALB', 'TSLA'],
  },
  {
    id: 'SN=F',
    type: 'commodity',
    name: 'Tin',
    aliases: ['tin', 'sn'],
    keywords: ['electronics', 'solder', 'coating', 'mining', 'industry'],
    related: ['HG=F', 'NI=F'],
  },
  // Precious Metals
  {
    ...
    type: 'commodity',
    name: 'Gold Futures',
    aliases: ['gold', 'xau', 'bullion', 'au'],
    keywords: ['precious metal', 'safe haven', 'inflation hedge', 'bullion', 'jewelry', 'USD inverse'],
    related: ['SI=F', 'PA=F', 'PL=F', 'DXY=F', 'CL=F'],
  },
  {
    id: 'SI=F',
    type: 'commodity',
    name: 'Silver Futures',
    aliases: ['silver', 'xag', 'ag'],
    keywords: ['precious metal', 'industrial metal', 'solar', 'electronics', 'photography', 'jewelry'],
    related: ['GC=F', 'HG=F', 'PA=F'],
  },
  {
    id: 'PL=F',
    type: 'commodity',
    ...
    aliases: ['platinum', 'pt'],
    keywords: ['precious metal', 'catalytic', 'automotive', 'industrial'],
    related: ['GC=F', 'SI=F', 'PA=F'],
  },
  {
    id: 'PA=F',
    type: 'commodity',
    ...
    keywords: ['precious metal', 'catalytic converter', 'automotive', 'emissions', 'mining'],
    related: ['GC=F', 'SI=F', 'PL=F', 'RU'],
  },
  // Agricultural Commodities  
  {
    ...
    name: 'Wheat Futures',
    aliases: ['wheat', 'zw'],
    keywords: ['grain', 'cereal', 'agriculture', 'food security', 'ukraine', 'russia'],
    related: ['ZC=F', 'ZS=F', 'ZR=F', 'UA', 'RU', 'CN'],
  },
  {
    id: 'ZC=F',
    type: 'commodity',
    name: 'Corn Futures',
    aliases: ['corn', 'maize', 'zc'],
    keywords: ['grain', 'agriculture', 'feed', 'ethanol', 'food', 'supply chain'],
    related: ['ZW=F', 'ZS=F', 'RU', 'UA'],
  },
  {
    id: 'ZS=F',
    type: 'commodity',
    ...
    keywords: ['agriculture', 'protein', 'feed', 'china demand', 'trade war', 'crop'],
    related: ['ZW=F', 'ZC=F', 'CN', 'RU', 'UA'],
  },
  {
    id: 'ZR=F',
    type: 'commodity',
    name: 'Rice Futures',
    aliases: ['rice', 'zr'],
    keywords: ['agriculture', 'staple', 'food security', 'asia', 'crop'],
    related: ['ZW=F', 'ZC=F', 'ZS=F', 'CN'],
  },
  {
    id: 'SB=F',
    type: 'commodity',
    name: 'Sugar Futures',
    aliases: ['sugar', 'sb'],
    keywords: ['agriculture', 'sweetener', 'ethanol', 'brazil', 'commodity'],
    related: ['CT=F', 'CC=F', 'KC=F'],
  },
  {
    id: 'CT=F',
    type: 'commodity',
    name: 'Cotton Futures',
    aliases: ['cotton', 'ct'],
    keywords: ['agriculture', 'textile', 'fiber', 'china demand', 'india'],
    related: ['SB=F', 'ZW=F', 'CN'],
  },
  {
    id: 'CC=F',
    type: 'commodity',
    name: 'Cocoa Futures',
    aliases: ['cocoa', 'cacao', 'cc'],
    keywords: ['agriculture', 'chocolate', 'commodity', 'ghana', 'ivory coast', 'weather'],
    related: ['KC=F', 'SB=F'],
  },
  {
    id: 'KC=F',
    ...
    name: 'Coffee Futures',
    aliases: ['coffee', 'kc'],
    keywords: ['agriculture', 'commodity', 'brazil', 'vietnam', 'weather', 'drought'],
    related: ['CC=F', 'SB=F', 'CT=F'],
  },
  // Freight & Market Indicators
  {
    ...
    aliases: ['bdi', 'baltic dry', 'freight'],
    keywords: ['shipping', 'logistics', 'freight', 'trade flow', 'commodity transport', 'indicators'],
    related: ['CL=F', 'HG=F', 'ZW=F'],
  },
  // Currency & Index
  {
    id: 'DXY=F',
    type: 'commodity',
    name: 'USD Index',
    aliases: ['dollar index', 'usd', 'dxy'],
    keywords: ['currency', 'usd strength', 'forex', 'commodities inverse', 'treasury'],
    related: ['GC=F', 'CL=F', 'JPM'],
  },
