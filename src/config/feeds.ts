...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  asia: [
    ...
    { name: 'Economic Times (Top)', url: rss('https://economictimes.indiatimes.com/rssfeedsdefault.cms'), lang: 'en' },
    { name: 'The Print', url: rss('https://theprint.in/feed/'), lang: 'en' },
    { name: 'Scroll.in', url: rss('https://scroll.in/feed'), lang: 'en' },
    { name: 'The Wire', url: rss('https://thewire.in/feed'), lang: 'en' },
    { name: 'News18 India', url: rss('https://www.news18.com/rss/india.xml'), lang: 'en' },
