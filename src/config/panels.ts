...
// ============================================
// UNIFIED CONFIGURATION (World + Tech + Finance)
// ============================================

const UNIFIED_PANELS: Record<string, PanelConfig> = {
  ...
  'fresh-water': { name: '💧 Fresh Water Resources', enabled: true, priority: 1 },
  ...
  ipo: { name: 'IPO, Earnings & M&A', enabled: true, priority: 2 },
...
const UNIFIED_MAP_LAYERS: MapLayers = {
  conflicts: true,
  bases: true,
  cables: true,
  pipelines: true,
...
const UNIFIED_MOBILE_MAP_LAYERS: MapLayers = {
  ...UNIFIED_MAP_LAYERS,
  bases: false,
  economic: false,
  waterways: false,
...
// ============================================
export const DEFAULT_PANELS = SITE_VARIANT === 'happy' ? HAPPY_PANELS : UNIFIED_PANELS;
export const DEFAULT_MAP_LAYERS = SITE_VARIANT === 'happy' ? HAPPY_MAP_LAYERS : UNIFIED_MAP_LAYERS;
export const MOBILE_DEFAULT_MAP_LAYERS = SITE_VARIANT === 'happy' ? HAPPY_MOBILE_MAP_LAYERS : UNIFIED_MOBILE_MAP_LAYERS;
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  marketsFinance: {
    ...
    panelKeys: ['commodities', 'markets', 'economic', 'trade-policy', 'supply-chain', 'finance', 'polymarket', 'macro-signals', 'etf-flows', 'stablecoins', 'crypto', 'heatmap', 'forex-market', 'markets-news', 'commodities-news', 'crypto-news', 'centralbanks', 'economic-news', 'derivatives', 'fintech', 'institutional', 'analysis', 'gcc-investments', 'gccNews'],
  },
  topical: {
    labelKey: 'header.panelCatTopical',
    panelKeys: ['energy', 'gov', 'thinktanks', 'layoffs'],
  },
  dataTracking: {
